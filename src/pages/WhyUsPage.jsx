...
const WhyUsPage = () => {
  ...
  const carouselItems = [
    [
      {
        category: 'Tabalt Ltd Insights',
        title: 'Horatio Hosts Successful Third Annual Client Summit',
        date: 'Mar 10 2025',
        description:
          'Tabalt Ltd, the modern outsourcing company revolutionizing CX services and the BPO industry, hosted its third annual Client Summit in Santo Domingo.',
        link: '#',
      },
      {
        category: 'Tabalt Ltd Insights',
        ...
        date: 'Apr 28 2025',
        description:
          'Tabalt Ltd has been named one of 2025 STEVIE® award winners in the 23rd annual American Business Awards.',
        link: '#',
      },
      {
        category: 'Tabalt Ltd Insights',
        ...
        date: 'Apr 01 2025',
        description:
          'Inc. revealed that Tabalt Ltd has been ranked No. 27 on its 2025 List of the Fastest-Growing Private Companies in the Northeast.',
        link: '#',
      },
    ],
    [
      {
        ...
        date: 'May 15 2025',
        description:
          'Tabalt Ltd announces strategic partnership to expand services and reach new markets.',
        link: '#',
      },
      {
        category: 'Tabalt Ltd Insights',
        ...
        date: 'Jun 01 2025',
        description:
          'Tabalt Ltd receives industry recognition for excellence in customer service outsourcing.',
        link: '#',
      },
      {
        category: 'Tabalt Ltd Insights',
        ...
        date: 'Jun 20 2025',
        description:
          'Tabalt Ltd expands operations to serve more clients with dedicated teams and resources.',
        link: '#',
      },
    ],
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <ContentSection
          ...
          description="Tabalt Ltd was born to help brand-focused, high-touch, innovative businesses turn customer interactions into revenue-generating opportunities."
          features={[
